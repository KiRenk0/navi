...
> 更新：2026-07-23（N3a.6 M8/30 observation binding 技术链冻结）
...
- 正式再生输入为 `fluent_export/adiabatic_wall_csv/30km_5alpha_8ma.csv` 的 geometry fields、`new_spec/htv2_0628.stl`、`new_spec/outline_xz_right_0629.csv`、`specs/vehicles/htv2_faceted3d_0629.yaml`、`specs/sampling/engineering_full_wing_surface_grid_81x41.yaml`，以及冻结的 x offset、projection gate、schema、algorithm、coordinate convention 与 tie-break。cache 缺失时可由这些冻结输入和已提交实现重新生成。
...
- M8/30 exact Fluent observation 已建立 tracked binding：CSV=`fluent_export/adiabatic_wall_csv/30km_5alpha_8ma.csv`，raw SHA-256=`5dc84e2dea4dc49a5f6ce777e71b8121c148b9490afeb83c98bd5ce022b3b865`，byte size=`3,123,901`，data rows=`21,250`，field=`wall-temperature`，unit=`K`。
...
- current source identity 为 source count=`64`、source paths hash=`2e69d8a851e47418fd988063acf6a0ed5d6b1777477b4a43567cc62d303ec9e8`。current 64-source builder golden 与 historical 61-source candidate 是不同对象；historical candidate 未被改写。
