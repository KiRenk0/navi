# Ablation Report: C_smoothstep

> Generated: 2026-06-30 00:56

## Description

Intermittency-only: transition.weighting = smoothstep

## Overrides

```
{
  "transition.weighting": "smoothstep"
}
```
...
| N/A | N/A | N/A | 0.0000 | 0.6362 | 0.2377 | 0.3915 | 0.6362 | N/A | 1.4393 |
| N/A | N/A | N/A | 0.0566 | 0.4798 | 0.1928 | 0.0926 | 0.4798 | N/A | 1.4342 |
...
| N/A | N/A | N/A | 0.0000 | 0.5333 | 0.1268 | 0.1544 | 0.5333 | N/A | 1.6657 |

## Figures

- `C_smoothstep_ma6_a5_h30km_qratio_vs_x.png`
- `C_smoothstep_ma6_a5_h30km_qratio_vs_wtr.png`
- `C_smoothstep_ma6_a5_h30km_qratio_box.png`
- `C_smoothstep_ma8_a5_h30km_qratio_vs_x.png`
- `C_smoothstep_ma8_a5_h30km_qratio_vs_wtr.png`
- `C_smoothstep_ma8_a5_h30km_qratio_box.png`
...
- ma6_a5_h30km / aft_body: q_ratio_mean=0.4798 (underestimate), std=0.1928, n_aligned=499
...
- ma8_a5_h30km / aft_body: q_ratio_mean=0.5333 (underestimate), std=0.1268, n_aligned=499
